...
export declare class ArtifactService {
  ...
  verify(path: string, options?: VerifyOptions): Promise<VerificationReport>;
  export(path: string, request: ExportRequest): Promise<ExportResult>;
  verifyFormat(path: string, format: ArtifactFormat): Promise<FormatVerification>;
}
...
export declare class Offprint {
  ...
  capture(url: string, options: CaptureOptions): Promise<CaptureReceipt>;
  close(): Promise<void>;
