...
use ipnet::IpNet;
use pageknot_model::{ErrorStage, NetworkPolicy, NetworkRules, PageKnotError, Result};
use url::{Host, Url};
...
fn network_error(code: &'static str, message: impl Into<String>) -> PageKnotError {
    PageKnotError::new(code, ErrorStage::Navigation, message)
}
