...
use pageknot_model::{
    ...
    NetworkPolicySummary, OutputCapability, PageKnotError, RecoveryAction, Result,
};
...
fn recovery_action(error: &PageKnotError) -> RecoveryAction {
    RecoveryAction {
...
fn acquisition_cancelled() -> PageKnotError {
    PageKnotError::new(
