(() => {
  ...
  var repairScriptElementId = "pageknot-repair-script";
  var stateScriptElementId = "pageknot-state-script";
  var repairMediaType = "application/vnd.pageknot.repair+json";
  var repairMarkerAttribute = "data-pageknot-node";
  var documentScrollXAttribute = "data-pageknot-scroll-x";
  var documentScrollYAttribute = "data-pageknot-scroll-y";
  var elementScrollLeftAttribute = "data-pageknot-scroll-left";
  var elementScrollTopAttribute = "data-pageknot-scroll-top";
  var animationMarkerAttribute = "data-pageknot-animation";
  var animationStyleAttribute = "data-pageknot-animation-style";
  var capturedShadowModeAttribute = "data-pageknot-shadow-mode";
...
`));
  ...
  function copyState(live, clone, context, snapshotInline) {
    if (isHtmlElement(live, "input") && isHtmlElement(clone, "input")) {
      ...
      setAttribute(cloneMedia, "data-pageknot-current-time", SafeString(mediaCurrentTime(liveMedia)));
  ...
  function copyInlineFrame(liveFrame, clone, context, snapshotInline) {
    try {
      ...
      setAttribute(clone, "data-pageknot-frame-base", documentBaseUri(childDocument));
