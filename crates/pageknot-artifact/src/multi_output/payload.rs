...
use pageknot_model::{
    ArtifactVariantVerification, ContentDigest, ErrorStage, PageKnotError, Result,
};
...
impl PreparedArtifact {
    ...
    pub(super) fn verification(&self) -> &ArtifactVariantVerification {
        &self.verification
    }
...
fn payload_error(message: impl Into<String>) -> PageKnotError {
    PageKnotError::new("pageknot.export.output", ErrorStage::Encoding, message)
}
...
mod tests {
    ...
    #[test]
    fn directory_digest_orders_root_files_before_nested_files() -> pageknot_model::Result<()> {
