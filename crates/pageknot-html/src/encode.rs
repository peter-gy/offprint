...
use pageknot_document::{Document, NodeData, serialize_document_to, set_document_scroll_state};
...
pub fn encode_html_to(
    ...
    if !manifest.resources.is_complete() {
        return Err(PageKnotError::new(
            "pageknot.artifact.resource_summary",
            ErrorStage::Encoding,
    ...
    fn encoded_artifact_carries_the_manifest_view_state_on_its_root() {
        ...
        assert!(html.as_ref().is_ok_and(|html| {
            html.contains(r#"data-pageknot-scroll-x="12.5""#)
                && html.contains(r#"data-pageknot-scroll-y="320""#)
