...
use markup5ever::ns;
use pageknot_model::{ErrorStage, NodeId, PageKnotError, ResourceId, Result};
use url::Url;
...
pub(super) fn resource_error(code: &'static str, message: impl Into<String>) -> PageKnotError {
