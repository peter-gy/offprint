...
pub const DOCUMENT_SCROLL_X_ATTRIBUTE: &str = "data-pageknot-scroll-x";
pub const DOCUMENT_SCROLL_Y_ATTRIBUTE: &str = "data-pageknot-scroll-y";
pub const ELEMENT_SCROLL_LEFT_ATTRIBUTE: &str = "data-pageknot-scroll-left";
pub const ELEMENT_SCROLL_TOP_ATTRIBUTE: &str = "data-pageknot-scroll-top";
...
mod tests {
    ...
    fn document_scroll_state_is_replaced_on_the_html_root() {
        let mut document = Document::parse(
            br#"<html data-pageknot-scroll-x="old"><head></head><body></body></html>"#,
        );
        ...
        assert!(html.is_ok_and(|html| {
            html.is_ok_and(|html| {
                html.contains(r#"data-pageknot-scroll-x="12.5""#)
                    && html.contains(r#"data-pageknot-scroll-y="48""#)
                    && !html.contains(r#"data-pageknot-scroll-x="old""#)
            })
        }));
    }
}
