...
use pageknot_model::{ArtifactVariantKind, Result};
...
pub fn verify_pdf(bytes: &[u8]) -> Result<VariantEvidence> {
    ...
    ensure_verified(ArtifactVariantKind::Pdf, structure_valid, content_valid)
}
