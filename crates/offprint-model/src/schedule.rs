...
use crate::{
    BrowserEnvironment, CaptureCredentials, CaptureId, CaptureLimits, CaptureOutput,
    CaptureReceipt, CaptureRequest, ContentDigest, ContentPolicy, DiagnosticsPolicy, NetworkPolicy,
    OffprintError, PortablePath, ReadinessPolicy, VerificationMode,
};
...
pub struct ResumeJobRecord {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<OffprintError>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<Url>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
