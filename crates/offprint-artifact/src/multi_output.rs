...
use offprint_model::{
    ConflictPolicy, ErrorStage, ExportedArtifact, OffprintError, PortablePath, Result,
};
...
fn clean_stage_failure(root: &Path, source: OffprintError) -> OffprintError {
...
fn stage_fault(root: &Path, point: FaultPoint, action: FaultAction) -> OffprintError {
