...
use pageknot_model::{
    CaptureId, CaptureRequest, ERROR_CODE_REGISTRY, ErrorStage, PageKnotError, RedactedUrl,
...
fn staging_error(message: impl Into<String>) -> PageKnotError {
    registered_error("pageknot.output.staging", message)
}

fn registered_error(code: &'static str, message: impl Into<String>) -> PageKnotError {
