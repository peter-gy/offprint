...
use pageknot::{ErrorStage, PageKnot, PageKnotError, Result};
...
pub(super) async fn execute(
    ...
    match cli.command {
            ...
            let operation = async {
                ...
                if report.ready {
                    ...
                    Err(PageKnotError::new(
                        ...
                        ErrorStage::Browser,
                        "PageKnot doctor found no ready browser configuration",
                    ))
                }
            }
            .await;
        ...
        Command::Inspect(arguments) => execute_inspect(arguments, input, output).await,
        Command::Verify(arguments) => execute_verify(arguments, input, output).await,
        ...
        Command::Export(arguments) => execute_export(arguments, input, output).await,
