...
use offprint_model::{CaptureId, ContentDigest, ErrorStage, OffprintError, Result};
...
pub fn negotiate_protocol(
    ...
    if handshake.protocol.major != host_version.major {
        return Err(OffprintError::new(
            "offprint.collector.protocol_major",
...
mod tests {
    ...
    use offprint_model::{CaptureId, ContentDigest};
    ...
    fn major_mismatch_fails_before_collection() {
        ...
        assert_eq!(
            ...
            Err("offprint.collector.protocol_major")
        );
    }
