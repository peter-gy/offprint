...
| PDF                  | Chromium print, semantic and action checks, source URLs and capture timestamp in document properties, and the complete provenance packet in Extensible Metadata Platform metadata |
