...
fn proxy_error(message: impl Into<String>) -> OffprintError {
    OffprintError::new("offprint.navigation.proxy", ErrorStage::Navigation, message)
}
...
mod tests {
    ...
    fn mixed_dns_answers_are_rejected_before_a_socket_is_opened() -> TestResult {
        ...
        assert_eq!(
            ...
            Err("offprint.navigation.address_blocked")
        );
        Ok(())
    }
