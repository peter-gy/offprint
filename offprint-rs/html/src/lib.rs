//! Offprint HTML encoding, manifest inspection, and static verification.
//!
...
pub const MANIFEST_ELEMENT_ID: &str = "offprint-manifest";
pub const MANIFEST_MEDIA_TYPE: &str = "application/vnd.offprint.manifest+json";
